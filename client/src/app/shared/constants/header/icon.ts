...
export const FAVORITE = 'assets/img/header/favorite.png'
export const ORDER_LIST = 'assets/img/header/order-list.png'
export const LIST = 'assets/img/header/list.png'